                                ...
                                <form id="form1" runat="server">
                                    <div class="table table-hover">
                                        <asp:GridView ID="GridView1" runat="server" class="table table-hover" AutoGenerateColumns="false" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                            ...
                                            <Columns>
                                                <asp:ImageField DataImageUrlField="t_pimage" HeaderText="Profile Image" ItemStyle-Height="50px" ControlStyle-Width="50px" ItemStyle-CssClass="item_img"></asp:ImageField>
