            ...
            <div class="cor">
                ...
                <div class="col-md-12">
                    <div class="cor-mid-img">
                        <img src="{% static 'Edu_Master/images/course.jpg' %}" alt="">
                    </div>
                    <div class="cor-con-mid">
                        ...
                        <div class="cor-p5">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <img src="{% static 'Edu_Master/images/icon/cor4.png' %}" alt=""> <span>Requirements</span></a>
                                </li>
                                <li><a data-toggle="tab" href="#menu1"><img src="{% static 'Edu_Master/images/icon/cor3.png' %}" alt=""><span>Fees</span></a></li>
                                <li><a data-toggle="tab" href="#menu2"><img src="{% static 'Edu_Master/images/icon/cor1.png' %}" alt=""><span>Student Profile</span></a></li>
                                <li><a data-toggle="tab" href="#menu2"><img src="{% static 'Edu_Master/images/icon/cor5.png' %}" alt=""><span>How to Apply</span></a></li>
                            </ul>
