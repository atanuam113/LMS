                                ...
                                <h3>Course Syllabus</h3>
                                        ...
                                        <%--<ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#home">
                                                <img src="{% static 'Edu_Master/images/icon/cor4.png' %}" alt="">
                                                <span>Requirements</span></a>
                                            </li>
                                            <li><a data-toggle="tab" href="#menu1">
                                                <img src="{% static 'Edu_Master/images/icon/cor3.png' %}" alt=""><span>Fees</span></a></li>
                                            <li><a data-toggle="tab" href="#menu2">
                                                <img src="{% static 'Edu_Master/images/icon/cor1.png' %}" alt=""><span>Student Profile</span></a></li>
                                            <li><a data-toggle="tab" href="#menu2">
                                                <img src="{% static 'Edu_Master/images/icon/cor5.png' %}" alt=""><span>How to Apply</span></a></li>
                                        </ul>--%>
                                <asp:DataList runat="server" ID="coursesyllabus">
                                    <ItemTemplate>
                                        <div class="tab-content">
                                            <div id="home">
                                                
                                                <p>Module No: <%#Eval("CModule_ID") %></p>
                                                <p>Week: <%#Eval("CS_Week") %></p>
                                                <h4>Topic: <%#Eval("CS_Module_Topic") %></h4>
                                                <p><%#Eval("CS_Desc") %></p>                                                                                                
