...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DataList runat="server" ID="datalist1" DataKeyField="id" Height="258px" DataSourceID="SqlDataSource2">
        <ItemTemplate>
            id:
            ...
            <br />
            e_desc:
            <asp:Label ID="e_descLabel" runat="server" Text='<%# Eval("e_desc") %>' />
            <br />
            e_date:
...
<br />
            ...
            <br />
            e_topic:
            <asp:Label ID="e_topicLabel" runat="server" Text='<%# Eval("e_topic") %>' />
            <br />
            e_end_time:
            <asp:Label ID="e_end_timeLabel" runat="server" Text='<%# Eval("e_end_time") %>' />
            <br />
            e_status:
            <asp:Label ID="e_statusLabel" runat="server" Text='<%# Eval("e_status") %>' />
            <br />
            e_link:
            <asp:Label ID="e_linkLabel" runat="server" Text='<%# Eval("e_link") %>' />
            <br />
            e_pimage:
            <asp:Label ID="e_pimageLabel" runat="server" Text='<%# Eval("e_pimage") %>' />
            <br />
            <br />
        </ItemTemplate>
        </asp:DataList>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:LMSConnectionString %>" SelectCommand="SELECT * FROM [eventsDtl] WHERE ([id] = @id)">
            <SelectParameters>
                <asp:QueryStringParameter Name="id" QueryStringField="id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LMSConnectionString %>" SelectCommand="SELECT [id], [e_desc], [e_name], [e_date], [e_time] FROM [eventsDtl]"></asp:SqlDataSource>
    <section>
    <div class="head-2">
        <div class="container">
            <div class="head-2-inn">
                ...
                <div class="event-head-sub">
                    <ul>
                        <li>Date: 07,MAY 2022</li>
                        <li>Time: 10:30 am – 5:00 pm</li>
            ...
            <div class="cor about-sp">
                <div class="s18-age-event l-info-pack-days">
                    <ul>
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/2.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/3.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                                    <span>09:00AM - 10:30AM</span>
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/4.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/5.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/6.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/7.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                                    <span>10:30AM - 10:45AM</span>
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/8.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                                    <span>10:30AM - 10:45AM</span>
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/9.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                                    <span>10:30AM - 10:45AM</span>
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/10.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                                    <span>10:30AM - 10:45AM</span>
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/11.png" alt="">
                            </div>
                            <div class="s17-eve-time">
                                <div class="s17-eve-time-tim">
                                    <span>10:30AM - 10:45AM</span>
                        ...
                        <li>
                            <div class="age-eve-com age-eve-1">
                                <img src="../fonts/images/icon/awa/12.png" alt="">
                            </div>
                            <div class="s17-eve-time s17-bor-bot-0">
                                ...
                                <div class="s17-eve-time-msg">
                                    <h4>Nation award winning 2022</h4>
                                </div>
                            </div>
                        </li>
