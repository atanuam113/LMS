...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="admin_exam_details"> Edit Exam</a>
            </li>
            <li class="page-back"><a href="admin_all_exam.aspx"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
            </li>
        </ul>
    </div>
                                            ...
                                            <div class="row">
                                              ...
                                              <!--      <input type="text" value="" class="validate">
                                                    <label class="">Main exam name</label>-->
                                                      ...
                                                      <asp:TextBox ID="textexam_name" class="validate" runat="server"  Font-Bold="True"></asp:TextBox>
                                                </div>
                                                <!--<div class="input-field col s12">
                                                    <input type="text" value="" class="validate">
                                                ...
                                                <div class="input-field col s12">
                                                    <!--<input type="text" value="" class="validate">
                                                    <label>Date</label>-->
                                                     <asp:TextBox ID="textexam_date"  class="validate" runat="server"  ForeColor="#CCCCCC" Font-Bold="True" TextMode="Date"></asp:TextBox>
                                                </div>
                                                <div class="input-field col s12">
                                                   <!-- <input type="text" value="" class="validate">
                                                    <label>Start time</label>-->
                                                     <asp:TextBox ID="textstart_time"  class="validate" runat="server"  ForeColor="#CCCCCC" Font-Bold="True" TextMode="Time"></asp:TextBox>
                                                </div>
                                                <div class="input-field col s6">
                                                   <!-- <input type="text" value="" class="validate">
                                                    <label>Duration</label>-->
                                                     <asp:TextBox ID="textduration"  class="validate" runat="server"  Font-Bold="True"></asp:TextBox>
                                                </div>
                                           </div>
                                            <div class="row">
                                                <div class="input-field col s6">
